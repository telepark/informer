...
static const char * const kUpdatedAppName = "Informer";

#ifdef Q_OS_WIN
static const char * const kAutoUpdaterFileName = "autoupdater.exe";
static const char * const kUpdatedAppFileName = "Informer.exe";
...
static const char * const kUpdatedAppFileName = "Informer.app";
