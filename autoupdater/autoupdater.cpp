...
void AutoUpdater::processDownloadFinished(const QString &archiveFilePath)
{
    ...
    m_progressDialog->setLabelText(tr("Extracting Informer updates, please wait..."));
    m_progressDialog->show();
...
void AutoUpdater::runUpdateAction(const QString &updateAction, const QString &updaterDirPath, bool ok)
{
    if (ok)
    {
        ...
        msgBox.setText(tr("Informer application is successfully updated"));
        msgBox.exec();
    }
...
void AutoUpdater::createProgressDialog()
{
    ...
    m_progressDialog->setLabelText(tr("Downloading Informer updates, please wait..."));
